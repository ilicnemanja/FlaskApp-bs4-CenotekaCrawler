...
class CenotekaCrawler:

    def __init__(self, url):
        self.url = url


    def get_col8_name(self, h4_tags, h4_text):
        for h4 in h4_tags:
    ...
    def retrieve(self):
        cenoteka_response = requests.get(self.url)
        ...
        for div_proizvod in proizvodi_links:
            ...
            if link and "href" in link.attrs:
                ...
                proizvodjac = self.get_col8_name(h4_tags, "Proizvođač")
                kolicina = self.get_col8_name(h4_tags, "Količina i jedinica mere")
                barkod = self.get_col8_name(h4_tags, "Poznati bar-kodovi")
                slika = ""
